        ...
        <nav class="nav">
          <div class="dropdown">
            <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
              <span class="logged-name hidden-md-down">Grados y Títulos</span>
            ...
            <div class="dropdown-menu dropdown-menu-header wd-200">
              <ul class="list-unstyled user-profile-nav">
                ...
                <li><a href=""><i class="icon ion-ios-gear"></i> Configuraci{on</a></li>
                <li><a href=""><i class="icon ion-ios-download"></i> Descargas</a></li>
                <li><a href=""><i class="icon ion-ios-star"></i> Favoritos</a></li>
                <li><a href=""><i class="icon ion-ios-folder"></i> Colección</a></li>
